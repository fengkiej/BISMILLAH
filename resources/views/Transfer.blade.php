		...
		<div class="content">
			...
			<script src="js/easyResponsiveTabs.js" type="text/javascript"></script>
					...
					<!-- Nominal -->
						...
						<input type="text" placeholder="" id="tambahpel" class="form-control" style="height:22px;width:93%;">
						<div class="input-group-btn">
							<button onclick="addElem()" id="tambahbtn" class="btn btn-success">+ Tambah</button>
						</div>
					</div>
						</div>
					<!-- total -->
